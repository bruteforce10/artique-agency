        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-12">
            {artiqueServices.map((service, index) => {
              ...
              const imageUrl = service.image?.url || `/services/${service.id}.webp`;
